...
wide wrer(const wide a11, const wide a22, const wide a21, const wide cs, const wide sn, const wide l1, const wide l2, wide *const ae, wide *const an)
{
...
wide wrec(const wide a11, const wide a22, const wide a21r, const wide a21i, const wide cs, const wide ca, const wide sa, const wide l1, const wide l2, wide *const ae, wide *const an)
{
...
wide wlam(wide L1, wide L2, wide l1, wide l2, wide *const relmax, wide *const relmin)
{
  L1 = fabsw(L1);
  L2 = fabsw(L2);
  l1 = fabsw(l1);
