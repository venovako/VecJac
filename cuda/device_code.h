...
__global__ void ccjac2(const float *const a11, const float *const a22, const float *const a21r, const float *const a21i, float *const cs, float *const snr, float *const sni, float *const l1, float *const l2, int *const sp)
{
  ...
  const float _l1 = scalbnf(__fdiv_rn(__fmaf_rn(_t1, __fmaf_rn(_a2, _t1,  _an), _a1), _s2), _es);
  const float _l2 = scalbnf(__fdiv_rn(__fmaf_rn(_t1, __fmaf_rn(_a1, _t1, -_an), _a2), _s2), _es);
  _sp |= (_l1 < _l2);
  cs[_off] = _cs;
  snr[_off] = _snr;
  sni[_off] = _sni;
...
__global__ void zcjac2(const double *const a11, const double *const a22, const double *const a21r, const double *const a21i, double *const cs, double *const snr, double *const sni, double *const l1, double *const l2, int *const sp)
{
  ...
  const double _l1 = scalbn(__ddiv_rn(__fma_rn(_t1, __fma_rn(_a2, _t1,  _an), _a1), _s2), _es);
  const double _l2 = scalbn(__ddiv_rn(__fma_rn(_t1, __fma_rn(_a1, _t1, -_an), _a2), _s2), _es);
  _sp |= (_l1 < _l2);
  cs[_off] = _cs;
  snr[_off] = _snr;
  sni[_off] = _sni;
