...
MODULE VECJAC
  ...
  INTERFACE
     INTEGER FUNCTION SJAC2F(N, A11, A22, A21, T, C, L1, L2, P) BIND(C,NAME='sjac2f_')
       USE, INTRINSIC :: ISO_C_BINDING, ONLY: C_INT
       IMPLICIT NONE
       INTEGER, INTENT(IN) :: N
       REAL, INTENT(IN) :: A11(MAX(N,VSL)), A22(MAX(N,VSL)), A21(MAX(N,VSL))
       REAL, INTENT(OUT) :: T(MAX(N,VSL)), C(MAX(N,VSL))
       REAL, INTENT(OUT) :: L1(MAX(N,VSL)), L2(MAX(N,VSL))
  ...
  ! ASSUMES (MOD(N,VSL) .EQ. 0)
  INTERFACE
     INTEGER FUNCTION SJAC2S(N, A11, A22, A21, CS, SN, L1, L2, P) BIND(C,NAME='sjac2s_')
       USE, INTRINSIC :: ISO_C_BINDING, ONLY: C_INT
       IMPLICIT NONE
       INTEGER, INTENT(IN) :: N
       REAL, INTENT(IN) :: A11(MAX(N,VSL)), A22(MAX(N,VSL)), A21(MAX(N,VSL))
       REAL, INTENT(OUT) :: CS(MAX(N,VSL)), SN(MAX(N,VSL))
       REAL, INTENT(OUT) :: L1(MAX(N,VSL)), L2(MAX(N,VSL))
       INTEGER(KIND=C_INT), INTENT(OUT) :: P(MAX(N,VSL)/VSL)
     END FUNCTION SJAC2S
  END INTERFACE
  ...
  ! ASSUMES (MOD(N,VDL) .EQ. 0)
  INTERFACE
     INTEGER FUNCTION DJAC2S(N, A11, A22, A21, CS, SN, L1, L2, P) BIND(C,NAME='djac2s_')
       USE, INTRINSIC :: ISO_C_BINDING, ONLY: C_INT
       IMPLICIT NONE
       INTEGER, INTENT(IN) :: N
       DOUBLE PRECISION, INTENT(IN) :: A11(MAX(N,VDL)), A22(MAX(N,VDL)), A21(MAX(N,VDL))
       DOUBLE PRECISION, INTENT(OUT) :: CS(MAX(N,VDL)), SN(MAX(N,VDL))
       DOUBLE PRECISION, INTENT(OUT) :: L1(MAX(N,VDL)), L2(MAX(N,VDL))
       INTEGER(KIND=C_INT), INTENT(OUT) :: P(MAX(N,VDL)/VDL)
     END FUNCTION DJAC2S
  END INTERFACE
  ...
  ! ASSUMES MOD(N,VSL) .EQ. 0
  INTERFACE
     INTEGER FUNCTION CJAC2F(N, A11, A22, A21R, A21I, T, C, CA, SA, L1, L2, P) BIND(C,NAME='cjac2f_')
       USE, INTRINSIC :: ISO_C_BINDING, ONLY: C_INT
       IMPLICIT NONE
       INTEGER, INTENT(IN) :: N
       REAL, INTENT(IN) :: A11(MAX(N,VSL)), A22(MAX(N,VSL)), A21R(MAX(N,VSL)), A21I(MAX(N,VSL))
       REAL, INTENT(OUT) :: T(MAX(N,VSL)), C(MAX(N,VSL))
       REAL, INTENT(OUT) :: CA(MAX(N,VSL)), SA(MAX(N,VSL))
       REAL, INTENT(OUT) :: L1(MAX(N,VSL)), L2(MAX(N,VSL))
       INTEGER(KIND=C_INT), INTENT(OUT) :: P(MAX(N,VSL)/VSL)
     END FUNCTION CJAC2F
  END INTERFACE
  ...
  ! ASSUMES MOD(N,VSL) .EQ. 0
  INTERFACE
     INTEGER FUNCTION CJAC2S(N, A11, A22, A21R, A21I, CS, CA, SA, L1, L2, P) BIND(C,NAME='cjac2s_')
       USE, INTRINSIC :: ISO_C_BINDING, ONLY: C_INT
       IMPLICIT NONE
       INTEGER, INTENT(IN) :: N
       REAL, INTENT(IN) :: A11(MAX(N,VSL)), A22(MAX(N,VSL)), A21R(MAX(N,VSL)), A21I(MAX(N,VSL))
       REAL, INTENT(OUT) :: CS(MAX(N,VSL)), CA(MAX(N,VSL)), SA(MAX(N,VSL))
       REAL, INTENT(OUT) :: L1(MAX(N,VSL)), L2(MAX(N,VSL))
       INTEGER(KIND=C_INT), INTENT(OUT) :: P(MAX(N,VSL)/VSL)
     END FUNCTION CJAC2S
  END INTERFACE
  ...
  ! ASSUMES MOD(N,VDL) .EQ. 0
  INTERFACE
     INTEGER FUNCTION ZJAC2S(N, A11, A22, A21R, A21I, CS, CA, SA, L1, L2, P) BIND(C,NAME='zjac2s_')
       USE, INTRINSIC :: ISO_C_BINDING, ONLY: C_INT
       IMPLICIT NONE
       INTEGER, INTENT(IN) :: N
       DOUBLE PRECISION, INTENT(IN) :: A11(MAX(N,VDL)), A22(MAX(N,VDL)), A21R(MAX(N,VDL)), A21I(MAX(N,VDL))
       DOUBLE PRECISION, INTENT(OUT) :: CS(MAX(N,VDL)), CA(MAX(N,VDL)), SA(MAX(N,VDL))
       DOUBLE PRECISION, INTENT(OUT) :: L1(MAX(N,VDL)), L2(MAX(N,VDL))
       INTEGER(KIND=C_INT), INTENT(OUT) :: P(MAX(N,VDL)/VDL)
     END FUNCTION ZJAC2S
  END INTERFACE
  ...
  INTERFACE
     REAL FUNCTION SJROT(N, X, Y, T, C) BIND(C,NAME='sjrot_')
       IMPLICIT NONE
       INTEGER, INTENT(IN) :: N
       REAL, INTENT(IN) :: C, T
  ...
  INTERFACE
     REAL FUNCTION CJROT(N, XR, XI, YR, YI, T, C) BIND(C,NAME='cjrot_')
       IMPLICIT NONE
       INTEGER, INTENT(IN) :: N
       REAL, INTENT(IN) :: C, T
       REAL, INTENT(INOUT) :: XR(MAX(N,VSL)), XI(MAX(N,VSL)), YR(MAX(N,VSL)), YI(MAX(N,VSL))
     END FUNCTION CJROT
  END INTERFACE
