...
fint zjac2_(const fnat n[static restrict 1], const double a11[static restrict VDL], const double a22[static restrict VDL], const double a21r[static restrict VDL], const double a21i[static restrict VDL], double t[static restrict VDL], double c[static restrict VDL], double ca[static restrict VDL], double sa[static restrict VDL],
#ifdef TEST_JAC2
            double l1[static restrict VDL], double l2[static restrict VDL],
#endif /* TEST_JAC2 */
            unsigned p[static restrict 1])
{
#ifndef NDEBUG
  if (IS_NOT_VFPENV)
    return -13;
...
#else /* !TEST_JAC2 */
#pragma omp parallel for default(none) shared(n,a11,a22,a21r,a21i,t,c,ca,sa,p) reduction(max:th)
#endif /* ?TEST_JAC2 */
