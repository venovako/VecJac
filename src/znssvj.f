...
*  ===========
*
*       SUBROUTINE ZNSSVJ( JOBA, JOBU, JOBV, M, N, A, LDA, SVA, MV, V,
*                          LDV, CWORK, LWORK, RWORK, LRWORK, NSWEEP, INFO )
*
*       .. Scalar Arguments ..
*       INTEGER            INFO, LDA, LDV, LWORK, LRWORK, M, MV, N, NSWEEP
...
*> \verbatim
*>
*> ZNSSVJ computes the singular value decomposition (SVD) of a complex
...
*>                 If INFO > 0,
*>                 the procedure ZNSSVJ did not converge in the given number
...
*>
*>          If INFO > 0:
*>          the procedure ZNSSVJ did not converge in the given number of
...
*> \verbatim
*>          MV is INTEGER
*>          If JOBV = 'A', then the product of Jacobi rotations in ZNSSVJ
...
*>                    This is useful information in cases when ZNSSVJ did
...
*>          > 0:  ZNSSVJ did not converge in the maximal allowed number
*>                (NSWEEP) of sweeps. The output may still be useful.
...
*     if ZNSSVJ is used as a computational routine in the preconditioned
