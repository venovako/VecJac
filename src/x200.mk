...
LDFLAGS=-L. -lvecjac_$(TEST)$(DEBUG)_$(ABI) -L${MKLROOT}/lib/intel64 -Wl,-rpath=${MKLROOT}/lib/intel64 -lmkl_intel_$(ABI) -lmkl_sequential -lmkl_core -lpthread -lm -ldl -lmemkind
