...
*  ===========
*
*       SUBROUTINE CNSSVJ( JOBA, JOBU, JOBV, M, N, A, LDA, SVA, MV, V,
...
*> \verbatim
*>
*> CNSSVJ computes the singular value decomposition (SVD) of a complex
...
*>                 If INFO > 0,
*>                 the procedure CNSSVJ did not converge in the given number
...
*>
*>          If INFO > 0 :
*>          the procedure CNSSVJ did not converge in the given number of
...
*> \verbatim
*>          MV is INTEGER
*>          If JOBV = 'A', then the product of Jacobi rotations in CNSSVJ
...
*>                    This is useful information in cases when CNSSVJ did
...
*>          > 0:  CNSSVJ did not converge in the maximal allowed number
...
*     if CNSSVJ is used as a computational routine in the preconditioned
