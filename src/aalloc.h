...
// allocates a properly aligned A (with ldA=\tilde{m}) and initializes it to identity
...
// allocates a properly aligned zero-filled A and its real and imaginary components (as identities)
