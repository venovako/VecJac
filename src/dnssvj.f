...
*  ===========
*
*       SUBROUTINE DNSSVJ( JOBA, JOBU, JOBV, M, N, A, LDA, SVA, MV, V,
...
*> \verbatim
*>
*> DNSSVJ computes the singular value decomposition (SVD) of a real
...
*> DNSSVJ can sometimes compute tiny singular values and their singular vectors much
...
*>                 If INFO > 0 :
*>                 the procedure DNSSVJ did not converge in the given number
...
*>          If INFO > 0 :
*>          the procedure DNSSVJ did not converge in the given number of
...
*> \verbatim
*>          MV is INTEGER
*>          If JOBV = 'A', then the product of Jacobi rotations in DNSSVJ
...
*>                    This is useful information in cases when DNSSVJ did
...
*>          > 0:  DNSSVJ did not converge in the maximal allowed number (30)
...
*     if DNSSVJ is used as a computational routine in the preconditioned
*     Jacobi SVD algorithm DNSSVJ. For sweeps i=1:SWBAND the procedure
