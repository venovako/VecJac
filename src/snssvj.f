...
*  ===========
*
*       SUBROUTINE SNSSVJ( JOBA, JOBU, JOBV, M, N, A, LDA, SVA, MV, V,
*                          LDV, WORK, LWORK, NSWEEP, INFO )
*
*       .. Scalar Arguments ..
...
*> \verbatim
*>
*> SNSSVJ computes the singular value decomposition (SVD) of a real
...
*> SNSSVJ can sometimes compute tiny singular values and their singular vectors much
...
*>                 If INFO > 0,
*>                 the procedure SNSSVJ did not converge in the given number
...
*>
*>          If INFO > 0 :
*>          the procedure SNSSVJ did not converge in the given number of
...
*> \verbatim
*>          MV is INTEGER
*>          If JOBV = 'A', then the product of Jacobi rotations in SNSSVJ
...
*>                    This is useful information in cases when SNSSVJ did
...
*>          > 0:  SNSSVJ did not converge in the maximal allowed number (30)
...
*     if SNSSVJ is used as a computational routine in the preconditioned
*     Jacobi SVD algorithm SNSSVJ. For sweeps i=1:SWBAND the procedure
