...
#ifdef Z8JACI_LOOP
#error Z8JACI_LOOP already defined
#else /* !Z8JACI_LOOP */
#define Z8JACI_LOOP                                                                                                    \
register VD a1 = _mm512_load_pd(a11 + i); VDP(a1);                                                                     \
register VD a2 = _mm512_load_pd(a22 + i); VDP(a2);                                                                     \
...
fint zbjac2i(const fint n[static restrict 1], const double a11[static restrict VDL], const double a22[static restrict VDL], const double a21r[static restrict VDL], const double a21i[static restrict VDL], double c[static restrict VDL], double cat[static restrict VDL], double sat[static restrict VDL], double l1[static restrict VDL], double l2[static restrict VDL], unsigned p[static restrict 1])
{
#ifndef NDEBUG
  if (IS_NOT_VFPENV)
    return -12;
