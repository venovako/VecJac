...
void _claev2(const float a11[static restrict 1], const float a21r[static restrict 1], const float a21i[static restrict 1], const float a22[static restrict 1], float l1[static restrict 1], float l2[static restrict 1], float cs1[static restrict 1], float snr[static restrict 1], float sni[static restrict 1])
{
...
void _zlaev2(const double a11[static restrict 1], const double a21r[static restrict 1], const double a21i[static restrict 1], const double a22[static restrict 1], double l1[static restrict 1], double l2[static restrict 1], double cs1[static restrict 1], double snr[static restrict 1], double sni[static restrict 1])
{
